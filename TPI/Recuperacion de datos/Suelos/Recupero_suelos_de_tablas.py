...
sites_collums = sites[['profile_identifier', 'latitude', 'longitude', 'country_code', 'fecha']]
...
# Ordeno por fecha
merged = merged.sort_values(by='fecha')

# Mostrar resultado
print(merged.head())

# Guardar si querés
merged.to_csv('suelo_unido.csv', index=False)